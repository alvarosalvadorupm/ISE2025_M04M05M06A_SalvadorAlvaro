...
/* Last-Modified: Mon, 24 Feb 2025 13:02:31 GMT */
const uint32_t imageLastModified = 1740402151U;

static const uint8_t imageFileData[25795U] = {
...
static const imageFileItem imageFileTable[19U+1U] = {
  ...
  { 0xCEC97D75U, &imageFileData[11493U] },    // "network.cgi"
  { 0x69E9F01DU, &imageFileData[13641U] },    // "system.cgi"
  { 0x5579E5A7U, &imageFileData[14892U] },    // "tcp.cgi"
  { 0xEEA8CB3DU, &imageFileData[15536U] },    // "xml_http.js"
  { 0xDE703953U, &imageFileData[18352U] },    // "home.png"
  { 0x90CE4E8AU, &imageFileData[19741U] },    // "keil.gif"
  { 0xA35A02C8U, &imageFileData[20879U] },    // "logo.gif"
  { 0x7049A0E1U, &imageFileData[22666U] },    // "llblue.jpg"
  { 0x3BDBDB05U, &imageFileData[25674U] },    // "pabb.gif"
  { 0x00000000U, &imageFileData[25795U] }
};
